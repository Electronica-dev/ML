...
class FeedForward(nn.Module):
	...
	def __init__(self, n_embd):
		...
		self.net = nn.Sequential(
			nn.Linear(n_embd, n_embd * 4), # multiplied by 4 because the attention paper does that
			nn.ReLU(),
...
class Block(nn.Module):
	...
	def __init__(self, n_embd, n_head):
		super().__init__()
		head_size = n_embd // n_head # this is so that everything works out channel wise
